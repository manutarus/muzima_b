...
public class   SummaryByEncountersFragment extends ObservationsListFragment {
    ...
    public static SummaryByEncountersFragment newInstance(ObservationController observationController) {
        SummaryByEncountersFragment f = new SummaryByEncountersFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        noDataMsg = getActivity().getResources().getString(R.string.summaries_still_loading);
