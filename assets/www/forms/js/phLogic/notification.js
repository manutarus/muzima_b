$(document).ready(function () {
    $('#patient\\.uuid').val($.fn.getUUID());
    $('#patient\\.medical_record_number').val($.fn.getMedicalNumber());
    $('#patient\\.family_name').val($.fn.getFamilyName());
    $('#patient\\.given_name').val($.fn.getGivenName());
    $('#patient\\.middle_name').val($.fn.getMiddleName());
    $('#patient\\.sex').val($.fn.getGender());
    $('#patient\\.birthdate').val($.fn.getBirthDay());
...
//                patient_hiv_status_visit_one
        ...
        }else if(elementId=='call_response'){
            $.each(divField, function (index, object) {
                $(object).change(function () {
                    var divToShowVal = $(this).val();
                    if (divToShowVal == "1066^NO^99DCT") {
                        $('#negative_response').show();
                        $('#follow_up_pull_up').hide();
                    } else {
                        $('#negative_response').hide();
                        if(divToShowVal !=""){
                            $('#follow_up_pull_up').show();
                        }else{
                            $('#follow_up_pull_up').hide();
                        }
                    }
...
//                patient_hiv_status_visit_one
    ...
    $('#patient\\.cPhone').val($.fn.currentPhoneNumber());
